...
DATE CREATED:  @Time : 2018/5/25 上午9:35
...
CHANGE:  : 
MODIFIED: : @Time : 2018/5/25 上午9:35
"""
...
def speckle(img):
    ...
    image_speck = img + blur
    image_speck[image_speck > 1] = 1
    image_speck[image_speck <= 0] = 0
    return image_speck
...
class TextImageGenerator(keras.callbacks.Callback):
    ...
    def __init__(self, monogram_file, bigram_file, minibatch_size, img_w, img_h, downsample_factor, val_split,
    ...
    def build_word_list(self, num_words, max_string_len=None, mono_fraction=0.5):
        ...
        with codecs.open(self.monogram_file, mode='r', encoding='tuf-8') as f:
            for line in f:
    ...
    def get_batch(self, index, size, train):
        ...
        inputs = {'the_input': X_data, 'the_labels': labels, 'input_lenth': input_length, 'label_length': label_length,
...
def decode_batch(test_func, word_batch):
    ...
    for j in range(out.shape[0]):
        ...
        out_best = [k for k, j in itertools.groupby(out_best)]
...
def train(run_name, start_epoch, stop_epoch, img_w):
    ...
    img_gen = TextImageGenerator(monogram_file=os.path.join(fdir, 'wordlist_mono_clean.txt'),
                                 ...
                                 minibatch_size=minibatch_size, img_w=img_w, img_h=img_h,
